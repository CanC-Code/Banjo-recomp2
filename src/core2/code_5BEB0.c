...
void mapSavestate_save(enum map_e map)
{
  ...
  if (D_8037E650[map] != 0)
  {
    n64_free(D_8037E650[map]);
  }
  D_8037E650[map] = (MapSavestate *) n64_malloc(4 * (sizeof(u32)));
  ...
  *valPtr = mapSpecificFlags_getAll();
  ...
  for (reg_s4 = func_803083B0(-2); reg_s4 != (-1); reg_s4 = func_803083B0(-2))
  {
    ...
    {
      wSize += 4;
      D_8037E650[map] = (MapSavestate *) n64_realloc(D_8037E650[map], wSize * new_var);
...
void mapSavestate_apply(enum map_e map_id) {
    ...
    n64_free((void*)D_8037E650[map_id] );
