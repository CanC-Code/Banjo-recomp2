...
void chBottlesBonus_update(Actor *this) {
    ...
    if (!this->volatile_initialized) {
        ...
        D_8037DEB8 = (Struct_core2_560F0_1 *) n64_malloc(CH_BOTTLES_BONUS_PUZZLE_PIECE_COUNT*sizeof(Struct_core2_560F0_1));
        D_8037DEBC = (Struct_core2_560F0_1 *) n64_malloc(CH_BOTTLES_BONUS_PUZZLE_PIECE_COUNT*sizeof(Struct_core2_560F0_1));
        D_8037DEC0 = (Struct_core2_560F0_1 *) n64_malloc(CH_BOTTLES_BONUS_PUZZLE_PIECE_COUNT*sizeof(Struct_core2_560F0_1));
        D_8037DEC4 = (Struct_core2_560F0_1 *) n64_malloc(CH_BOTTLES_BONUS_PUZZLE_PIECE_COUNT*sizeof(Struct_core2_560F0_1));
    }
