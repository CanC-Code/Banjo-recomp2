...
void func_802EA418(Struct_core2_63410_0 **arg0, Struct_core2_63410_2 *arg1, f32 arg2[3], f32 arg3[3]) {
    ...
    if (phi_s1->unk4 == phi_s1->unk8) {
        ...
        sp20 = sp34 * 2;
        phi_s1 = (Struct_core2_63410_0 *)n64_realloc(phi_s1, sizeof(Struct_core2_63410_0) + (sizeof(Struct_core2_63410_1)*sp20));
...
Struct_core2_63410_0 *func_802EA5E4(void){
    ...
    phi_v0 = (Struct_core2_63410_0 *)n64_malloc(sizeof(Struct_core2_63410_0) + 2 * sizeof(Struct_core2_63410_1));
