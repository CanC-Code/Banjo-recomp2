    ...
    while (i < arg0->unk4 - 1) {
        ...
        if (!(i_ptr->unk23 & 1)) {
            ...
            if (i_ptr != end_ptr) {
                ...
                n64_memcpy(i_ptr, end_ptr, sizeof(Struct65s));
            } else {
            ...
            if (arg0->unk4 != 0) {
                ...
                arg0->unk0 = (Struct65s *)n64_realloc(arg0->unk0, arg0->unk4 * sizeof(Struct65s));
            } else {
...
void *func_802F2AEC(void) {
    ...
    if (D_80368AB4 == 0) {
        ...
        D_80380A10 = (f32 *)n64_malloc(0x100*sizeof(f32));
        for(var_s1 = 0; var_s1 < 0x100; var_s1++){
            D_80380A10[var_s1] = 0.0f;
        };
    }
    D_80368AB4++;
    temp_v0 = n64_malloc(8);
    if (temp_v0 == NULL) {
        return NULL;
    }
    temp_v0->unk0 = 0;
...
void func_802F2FCC(Struct64s *arg0, f32 arg1[3], s16 arg2, f32 arg3, ActorMarker *arg4, s32(*arg5)(f32[3], f32, ActorMarker *)){
    ...
    if (arg0 != NULL) {
        if ((arg0->unk4 != 0x20) && (D_80380A58 >= 0x19000)) {
            if ( arg0->unk0 != NULL) {
                var_v0 = (Struct65s *)n64_realloc(arg0->unk0, (arg0->unk4 + 1)*sizeof(Struct65s));
            } else {
                var_v0 = n64_malloc(sizeof(Struct65s));
            }
            if (var_v0 != NULL) {
                arg0->unk0 = var_v0;
                var_v0 += arg0->unk4;
